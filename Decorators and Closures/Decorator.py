"""
    ...
    original target function, but to whatever function is returned by decorator(target)
"""
...
"""
    Strictly speaking, decorators are just syntactic sugar. As we just saw, you can always simply call a decorator like
