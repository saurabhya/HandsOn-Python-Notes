...
'''
    Now we can easily establish that the A vertex has the adjacent vertices of B and C. The F vertex has the C vertex as
...
'''
    ...
    Another approach by which a graph can be repesented is by using adjacency matrix. A mtrix is a two dimensional array.
